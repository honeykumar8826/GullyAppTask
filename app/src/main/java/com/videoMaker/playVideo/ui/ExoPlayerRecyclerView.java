package com.videoMaker.playVideo.ui;
...
import com.videoMaker.utils.VideoPlayerConfig;
...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    public ExoPlayerRecyclerView(Context context,
        ...
        Log.i(TAG, "ExoPlayerRecyclerView: 3");
        initialize(context);
    }
    ...
    private void initialize(Context context) {
        ...
        addOnChildAttachStateChangeListener(new OnChildAttachStateChangeListener() {
            ...
            //    Log.i(TAG, "onChildViewAttachedToWindow: 6");
            ...
            public void onChildViewDetachedFromWindow(View view) {
              ...
              //  Log.i(TAG, "onChildViewDetachedFromWindow:  on detach6");
            }
        });
        player.addListener(new Player.EventListener() {
            ...
            public void onLoadingChanged(boolean isLoading) {
                //Toast.makeText(appContext, "video is loading", Toast.LENGTH_SHORT).show();
            }
