...
import com.gullyApp.camera.ui.base.BaseFragment;
...
public abstract class CameraVideoFragment extends BaseFragment {
    ...
    public void startRecordingVideo() {
        ...
        try {
            ...
            /**
             * for starting the count down timer
             */
            startCountDownTimer();
    ...
    private void startCountDownTimer() {
      ...
      waitTimer =new CountDownTimer(8000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                CameraFragment.remainSecond.setText(""+millisUntilFinished / 1000);
                //here you can have your logic to set text to edittext
            }

            public void onFinish() {
                CameraFragment.remainSecond.setText("done!");
            }
